...
public class SocialNetwork extends ConcreteGraph {
	...
	public static List<Class<? extends Vertex>> vertexWhiteList = Arrays.asList(Person.class);
	public static List<Class<? extends Edge>> edgeWhiteList = Arrays.asList(Tie.class);
