...
public class GraphMetricsTest {
	...
	public void setUp() throws Exception {
		graph1 = ParseCommandHelper.buildGraphFromFile("test/helper/testcase.txt");
		graph2 = ParseCommandHelper.buildGraphFromFile("test/helper/testcase2.txt");
		graph3 = ParseCommandHelper.buildGraphFromFile("test/helper/testcase3.txt");
		graph4 = ParseCommandHelper.buildGraphFromFile("test/helper/testcase4.txt");
		graph5 = ParseCommandHelper.buildGraphFromFile("test/helper/testcase5.txt");
	}
