...
public class GraphPoetTest extends ConcreteGraphTest {
	...
	public void testGraphPoet() throws IOException {
		GraphPoet graph = new GraphPoet("graph", "test/graph/poem1.txt");
	...
	public void testPoem() throws IOException {
		// covers no bridge
		GraphPoet graphPoet = new GraphPoet("graph", "test/graph/poem1.txt");
		...
		graphPoet = new GraphPoet("graph", "test/graph/poem2.txt");
	...
	public void testGetBridge() throws IOException {
		GraphPoet graphPoet = new GraphPoet("graph", "test/graph/poem2.txt");
