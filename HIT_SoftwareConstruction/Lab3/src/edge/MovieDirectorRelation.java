...
public class MovieDirectorRelation extends Edge {
	 ...
	 * The second vertex in list is Instance of Director. the weight of edge should be
	 * -1.
	 * 
	 ...
	 * {@link Director}. if the source and target has been set or the vertices doesn't
	 ...
	 * @return return a MovieDirectorRelationship Instance connecting movie and actor.
