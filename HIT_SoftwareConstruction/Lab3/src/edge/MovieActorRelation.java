...
public class MovieActorRelation extends Edge {
	 ...
	 * The second vertex in list is Instance of Actor. the weight of edge should be
	 * -1.
	 * 
	 ...
	 * {@link Actor}. if the source and target has been set or the vertices doesn't
	 * correspond to representations, it will do nothing and return false.
	 * 
	 * @param vertices
	 ...
	 * @return return a MovieActorRelationship Instance connecting movie and actor.
	 *         if the vertices are invalid, return null
	 */
	public static MovieActorRelation wrap(String label, List<Vertex> vertices, double weight) {
		if (vertices.size() != 2)
			return null;
