...
public abstract class Vertex implements Cloneable {
	 ...
	 * method returns a string that "textually represents" this vertex. The
	...
	/**
	 * get string format of vertex information
	 * @return string format of vertex information
	 */
	public abstract List<String> getVertexInfo();
