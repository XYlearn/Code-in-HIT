...
public interface Graph<L, E> {
	...
	/**
	 * check if the graph allow duplicate edge
	 * 
	 * @return retrun false if duplicated edges are not allowed
	 */
	public boolean allowDuplicateEdge();

	/**
	 * check if the graph allow hyperedge
	 * 
	 * @return return false if hyperedge is not allowed
	 */
	public boolean allowHyperEdge();

	/**
	 * check if the graph allow loop
	 * 
	 * @return return true if graph allows loop
	 */
